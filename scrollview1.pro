...
UBUNTU_TRANSLATION_DOMAIN="scrollview1.liu-xiao-guo"
...
aptest.commands = bash $$PWD/scrollview1/tests/autopilot/run
aptest.depends  = sub-scrollview1

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/scrollview1/tests/unit
unittest.depends  = sub-scrollview1
